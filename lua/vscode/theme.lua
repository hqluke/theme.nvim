...
theme.set_highlights = function(opts)
    ...
    hl(0, 'BufferCurrent', { fg = '#D7BA7D', bg = c.vscTabCurrent })
    hl(0, 'BufferCurrentIndex', { fg = '#D7BA7D', bg = c.vscTabCurrent })
    hl(0, 'BufferCurrentMod', { fg = '#D7BA7D', bg = c.vscTabCurrent })
    hl(0, 'BufferCurrentSign', { fg = '#D7BA7D', bg = c.vscTabCurrent })
    hl(0, 'BufferCurrentTarget', { fg = '#D7BA7D', bg = c.vscTabCurrent })
    hl(0, 'BufferVisible', { fg = '#666666', bg = c.vscTabCurrent })
    hl(0, 'BufferVisibleIndex', { fg = '#666666', bg = c.vscTabCurrent })
    hl(0, 'BufferVisibleMod', { fg = '#D7BA7D', bg = c.vscTabCurrent })
    hl(0, 'BufferVisibleSign', { fg = '#D7BA7D', bg = c.vscTabCurrent })
    hl(0, 'BufferVisibleTarget', { fg = '#D7BA7D', bg = c.vscTabCurrent })
    hl(0, 'BufferInactive', { fg = '#666666', bg = c.vscTabOther })
    hl(0, 'BufferInactiveIndex', { fg = '#666666', bg = c.vscTabOther })
    hl(0, 'BufferInactiveMod', { fg = '#D7BA7D', bg = c.vscTabOther })
    hl(0, 'BufferInactiveSign', { fg = '#D7BA7D', bg = c.vscTabOther })
    hl(0, 'BufferInactiveTarget', { fg = '#D7BA7D', bg = c.vscTabOther })
    hl(0, 'BufferTabpage', { fg = '#D7BA7D', bg = c.vscTabOther })
    hl(0, 'BufferTabpageFill', { fg = '#D7BA7D', bg = c.vscTabOther })
    hl(0, 'BufferTabpages', { fg = '#D7BA7D', bg = c.vscTabOther })
    hl(0, 'BufferTabpagesFill', { fg = '#D7BA7D', bg = c.vscTabOther })
    ...
    -- Neotree
    -- I got no mfing clue. these colors are lying
    hl(0, 'NeoTreeBufferNumber', { fg = '#D7BA7D', bg = 'NONE' })
    hl(0, 'NeoTreeCursorLine', { fg = 'NONE', bg = c.vscCursorDarkDark })
    hl(0, 'NeoTreeDimText', { fg = 'NONE', bg = c.vscCursorDarkDark })
    hl(0, 'NeoTreeDirectoryIcon', { fg = '#666666', bg = 'NONE' })
    hl(0, 'NeoTreeDirectoryName', { fg = '#666666', bg = 'NONE' })
    hl(0, 'NeoTreeDotfile', { fg = c.vscDisabledBlue, bg = 'NONE' })
    hl(0, 'NeoTreeExpander', { fg = '#D7BA7D', bg = 'NONE' })
    hl(0, 'NeoTreeFileIcon', { fg = '#FFFF00', bg = 'NONE' })
    hl(0, 'NeoTreeFileName', { fg = '#999999', bg = 'NONE' })
    hl(0, 'NeoTreeFileNameOpened', { fg = '#D7BA7D', bg = c.vscCursorDarkDark })
    hl(0, 'NeoTreeFilterTerm', { fg = '#D7BA7D', bg = 'NONE' })
    hl(0, 'NeoTreeFloatBorder', { fg = '#999999', bg = 'NONE' })
    hl(0, 'NeoTreeFloatTitle', { fg = '#555555', bg = 'NONE' })
    hl(0, 'NeoTreeGitDir', { fg = '#D7BA7D', bg = 'NONE' })
    -- this changes the drop down bar line
    hl(0, 'NeoTreeIndentMarker', { fg = '#D7BA7D', bg = 'NONE' })
    -- this changes the dir path name
    hl(0, 'NeoTreeRootName', { fg = '#999999', bg = 'NONE' })
    hl(0, 'NeoTreeTitleBar', { fg = '#555555', bg = 'NONE' })
